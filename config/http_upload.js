 ...
 module.exports = function (grunt) {
     return {
         ...
         mobileBuilder: {
             options: {
                 url: 'builder.gft.com' + '/builder/service_5_0',
                 method: 'POST',
                 rejectUnauthorized: false,
                 headers: {
                     'Authorization': 'Basic ' + new Buffer('unity:unity2011').toString('base64')
                 },
                 data: {
         ...
         windowsMobileBuilder: {
             options: {
                 url: 'builder.gft.com' + '/builder-winphone/service_win_phone_5_0',
                 method: 'POST',
                 rejectUnauthorized: false,
                 headers: {
                     'Authorization': 'Basic ' + new Buffer('unity:unity2011').toString('base64')
